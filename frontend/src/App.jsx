    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          {({"asos":"ASOS","very":"Very","mintvelvet":"Mint Velvet","nobodyschild":"Nobody's Child","marksandspencer":"M&S","riverisland":"River Island","sezane":"Sézane"})[product.source] || product.source}
        </div>
      </div>
...
export default function PaletteApp() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return items;
  }, [products, activeSource, activeColors, showFavsOnly, favorites, sortBy]);
  ...
  const hasFilters = activeColors.size > 0 || activeSource !== "all" || showFavsOnly || activeGroup !== "all";
